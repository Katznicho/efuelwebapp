            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!--col-->
                        <div class="col-lg-3 col-6">
                            <a href="/efuelwebapp/views/fuelstation/activeOnEachStage.php?stationname=<?=$fuelStationName?>&data=activebodausers">
                                <div class="small-box bg-success">
                                    <div class="inner">
                        ...
                        <!--col-->
                        <div class="col-lg-3 col-6">
                            <a href="/efuelwebapp/views/fuelstation/activeOnEachStage.php?stationname=<?=$fuelStationName?>&data=inactivebodausers">
                                <div class="small-box bg-success">
                                    <div class="inner">
                        ...
                        <!--col-->
                        <div class="col-lg-3 col-6">
                            <a href="/efuelwebapp/views/fuelstation/activeOnEachStage.php?stationname=<?=$fuelStationName?>&data=defaultedbodausers">
                                <div class="small-box bg-success">
                                    <div class="inner">
                        ...
                        <!--col-->
                        <div class="col-lg-3 col-6">
                            <a href="/efuelwebapp/views/stage/indexone.php?name=<?=$fuelStationName?>&data=activestages">
                                <div class="small-box bg-success">
                                    <div class="inner">
                        ...
                        <!--col-->
                        <div class="col-lg-3 col-6">
                            <a href="/efuelwebapp/views/stage/indexone.php?name=<?=$fuelStationName?>&data=inactivestages">
                                <div class="small-box bg-success">
                                    <div class="inner">
                        ...
                        <!--col-->
                        <div class="col-lg-3 col-6">
                            <a href="/efuelwebapp/views/stage/indexone.php?name=<?=$fuelStationName?>&data=defaultedstages">
                                <div class="small-box bg-success">
                                    <div class="inner">
