                                ...
                                <div class="row">
                                    <div class="col-md-3 border-right">
                                        <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                            <img class=" mt-1" width="250px" src="<?= "http://207.154.233.21/bodafuelprojectmobileapi/storage/app/public/images/id_cards/" . $personDetails[0]['frontIDPhoto']; ?>">
                                        ...
                                        <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                            <img class=" mt-1" width="250px" src="<?= "http://207.154.233.21/bodafuelprojectmobileapi/storage/app/public/images/id_cards/" . $personDetails[0]['backIDPhoto']; ?>">
