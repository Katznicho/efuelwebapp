...
<head>
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href=" /efuelwebapp/plugins/daterangepaicker/daterangepicker.css">
    <!-- summernote -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- jQuery -->
    <script src="/efuelwebapp/plugins/plugins/jquery/jquery.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
    <script src=" /efuelwebapp/plugins/plugins/jquery-ui/jquery-ui.min.js"></script>
