...
$message = "Hello " . $details[0]['msisdn'] . " Your payment of shs " . $details[0]['amount'] . " has been received successfully";

$sms->sendSms($message, $sms->formatMobileInternational($details[0]['msisdn']));
